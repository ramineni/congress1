...
class NeutronV2Driver(datasource_driver.DataSourceDriver,
        ...
        'field-translators':
            ({'fieldname': 'id', 'desc': 'The UUID of the floating IP address',
             ...
             {'fieldname': 'floating_network_id',
              'desc': 'The UUID of the network associated with the floating IP',
              'translator': value_trans},
             ...
             {'fieldname': 'port_id', 'desc': 'UUID of port', 'translator': value_trans},
    ...
    ports_translator = {
        ...
        'selector-type': 'DICT_SELECTOR',
        'field-translators':
            ({'fieldname': 'id', 'desc': 'UUID of port', 'translator': value_trans},
             {'fieldname': 'tenant_id', 'desc': 'tenant ID', 'translator': value_trans},
             {'fieldname': 'name', 'desc': 'port name', 'translator': value_trans},
    ...
    external_fixed_ips_translator = {
        ...
        'in-list': True,
        'field-translators':
            ({'fieldname': 'subnet_id', 'desc': '', 'translator': value_trans},
             {'fieldname': 'ip_address', 'desc': '', 'translator': value_trans})}
    ...
    routers_external_gateway_infos_translator = {
        ...
        'selector-type': 'DICT_SELECTOR',
        'field-translators':
            ({'fieldname': 'network_id', 'desc': '', 'translator': value_trans},
             {'fieldname': 'enable_snat', 'desc': '', 'translator': value_trans},
             {'fieldname': 'external_fixed_ips', 'desc': '', 
    ...
    routers_translator = {
        ...
        'selector-type': 'DICT_SELECTOR',
        'field-translators':
            ({'fieldname': 'id', 'desc': '', 'translator': value_trans},
             {'fieldname': 'tenant_id', 'desc': '', 'translator': value_trans},
             {'fieldname': 'status', 'desc': 'router status',
              'translator': value_trans},
             {'fieldname': 'admin_state_up', 'desc': '', 'translator': value_trans},
             {'fieldname': 'name', 'desc': '', 'translator': value_trans},
             {'fieldname': 'distributed', 'desc': '', 'translator': value_trans},
             {'fieldname': 'external_gateway_info', 'desc': '', 
    ...
    security_group_rules_translator = {
        ...
        'field-translators':
            ({'fieldname': 'id', 'desc': 'The UUID of the security group rule',
              'translator': value_trans},
             {'fieldname': 'tenant_id', 'desc': '', 'translator': value_trans},
             {'fieldname': 'remote_group_id', 'desc': '', 'translator': value_trans},
             {'fieldname': 'direction',
