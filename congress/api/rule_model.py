...
class RuleModel(base.APIModel):
    ...
    def get_item(self, id_, params, context=None):
        ...
        try:
            ...
            return self.invoke_rpc('engine', 'persistent_get_rule', args)
    ...
    def get_items(self, params, context=None):
        ...
        try:
            ...
            # Note(thread-safety): blocking call
            rules = self.invoke_rpc('engine', 'persistent_get_rules', args)
    ...
    def add_item(self, item, params, id_=None, context=None):
        ...
        try:
            ...
            # Note(thread-safety): blocking call
            return self.invoke_rpc('engine', 'persistent_insert_rule', args)
        except exception.CongressException as e:
            raise webservice.DataModelException.create(e)
    ...
    def delete_item(self, id_, params, context=None):
        ...
        try:
            ...
            # Note(thread-safety): blocking call
            return self.invoke_rpc('engine', 'persistent_delete_rule', args)
        except exception.CongressException as e:
            raise webservice.DataModelException.create(e)
